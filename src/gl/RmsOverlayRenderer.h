...
namespace gl_detail {
struct RmsOverlaySnapshot {
  float rmsValues[128]       {};
  float barBoundaries[129]   {};
  int   numBars  = 0;
  float ampScale = 1.0f;
  bool  show     = false;
};
 ...
 */
class RmsOverlayRenderer : public GLRendererBase,
                           protected GLSnapshotRenderer<gl_detail::RmsOverlaySnapshot> {
  public:
  ...
  private:
    using Snapshot = gl_detail::RmsOverlaySnapshot;
